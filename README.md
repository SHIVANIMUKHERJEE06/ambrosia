...
> ⚠️ **Before presenting:** Replace `your-username` everywhere with your actual GitHub username.
...
git clone https://github.com/SHIVANIMUKHERJEE06/ambrosia
...
## Demo day checklist
- [ ] Replace `your-username` in README, About.jsx, CONTRIBUTING.md
